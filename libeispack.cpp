...
/*
  ...
  Parameters:
    ...
    Input, int MATZ, is 1 if the transformation matrix is
    to be accumulated, and 0 otherwise.

    Output, double Z[N*N], the orthogonal transformation matrix
    produced in the reduction if MATZ is 1.  Otherwise, Z is
    not referenced.
*/
{
  double b1;
...
/*
  ...
  Parameters:
    ...
    Input, int MATZ, is 0 if only eigenvalues are desired, and
    1 if both eigenvalues and eigenvectors are to be computed.

    Output, double ZR[N*N], ZI[N*N], the real and imaginary parts,
    respectively, of the eigenvectors, if MATZ is 1.
...
int ch ( int n, double ar[], double ai[], double w[], int matz, double zr[], 
  double zi[] )
...
int ch3 ( int n, double a[], double w[], int matz, double zr[], double zi[] )
...
int cinvit ( int n, double ar[], double ai[], double wr[], double wi[], 
  int select[], int mm, int *m, double zr[], double zi[] )
...
int invit ( int n, double a[], double wr[], double wi[], int select[], 
...
void qzhes ( int n, double a[], double b[], int matz, double z[] )
...
int qzit ( int n, double a[], double b[], double eps1, int matz, double z[] )
...
/*
  ...
  Parameters:
    ...
    Input, int MATZ, should be 1 if the right hand transformations
    are to be accumulated for later use in computing eigenvectors, and
    0 otherwise.

    Input/output, double Z[N*N], is only used if MATZ is 1.
...
int ratqr ( int n, double eps1, double d[], double e[], double e2[], int m, 
  double w[], int ind[], double bd[], int type, int idef )
...
/*
  ...
  Parameters:
    ...
    Input, int TYPE, should be set to 1 if the smallest eigenvalues
    are to be found, and to 0 if the largest eigenvalues are to be found.
    ...
    0, for normal return,
    6*N+1, if IDEF is set to 1 and TYPE to .1. when the matrix is not
      positive definite, or if IDEF is set to -1 and TYPE to .0.
...
int rg_elm ( int n, double a[], double wr[], double wi[], int matz, 
  double z[] )
...
/*
  ...
  Parameters:
    ...
    Input, int MATZ, is 0 if only eigenvalues are desired, 
    and 1 if both eigenvalues and eigenvectors are desired.
    ...
    the eigenvectors if MATZ is 1.  If the J-th eigenvalue is real, the
...
int rg_ort ( int n, double a[], double wr[], double wi[], int matz, 
  double z[] )
...
int rsg ( int n, double a[], double b[], double w[], int matz, double z[] )
...
int rsgab ( int n, double a[], double b[], double w[], int matz, double z[] )
...
int rsgba ( int n, double a[], double b[], double w[], int matz, double z[] )
...
int rsp ( int n, int nv, double a[], double w[], int matz, double z[] )
...
int rspp ( int n, int nv, double a[], double w[], int matz, double z[], int m, 
  int type )
...
/*
  ...
  Parameters:
    ...
    Input, int TYPE, is 1 if the smallest eigenvalues
    are to be found, or 0 if the largest ones are sought.
...
int rst ( int n, double w[], double e[], int matz, double z[] )
...
int rt ( int n, double a[], double w[], int matz, double z[] )
...
/*
  ...
  Parameters:
    ...
    Output, double Z[N,N], contains the eigenvectors, if MATZ is 1.
...
int svd ( int m, int n, double a[], double w[], int matu, double u[], 
  int matv, double v[] )
